...
namespace DigiCuitTester_alpha2
{
    public partial class UserInterface : Form
    {
        ...
        {
            InitializeComponent();
            rend = new Renderer(this.circuit, this.Canvas);
            LoadJsGlobals();
        }
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                this.comp = new DigiCuit_alpha2.ElectricComponents.Component(this.FrameWorkFile, this.ClassFile,0);
        ...
        { this.isPlaying = false; this.circuit.Stop(); }
        ...
        private void listBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            if (i >= 0 && cComponentList.Items[i].GetType() == typeof(DigiCuit_alpha2.ElectricComponents.Component))
            {
                ...
                this.SelectedDcv = new DigiCuit_alpha2.ElectricComponents.DirectCurrent(this.comp.jsGlobals);
                cmbInOutList.Items.Clear();
                cmbInOutList.Items.AddRange(this.comp.InOut.ToArray());

                cCompProperties.Items.Clear();
                cCompProperties.Items.AddRange(this.comp.Properties.ToArray());
            }
        }

        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            int i = this.SelectedDcvIndex = cmbInOutList.SelectedIndex;
            if (i >= 0)
            {
                textBox1.Text = "InOutIndex: " + i.ToString();
                string json = cmbInOutList.Items[i].ToString();
                this.SelectedDcv.CreatFromJSON(json);
        ...
        {
            this.cmbInOutList.Items[this.SelectedDcvIndex] = this.SelectedDcv;
        }

        private void button6_Click(object sender, EventArgs e)
        {
            object[] json = cmbInOutList.Items.Cast<object>().ToArray();
            this.comp.InOut.Clear();
            this.comp.InOut.AddRange(json);
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                DigiCuit_alpha2.ElectricComponents.Component nComp
                    = new DigiCuit_alpha2.ElectricComponents.Component(this.FrameWorkFile, dlg.FileName,0);
        ...
        {
            this.circuit.PlugMatrix.Add(new DigiCuit_alpha2.ElectricComponents.Component.Marker());
            this.cLinkerList.Items.Clear();
            object[] lComps = this.circuit.PlugMatrix.Cast<object>().ToArray();
        ...
        private void toolStripButton10_Click(object sender, EventArgs e)
        {
            ...
            if (i >= 0)
            {
                ...
                this.circuit.PlugMatrix.Clear();
                DigiCuit_alpha2.ElectricComponents.Component.Marker[] lComps = this.cLinkerList.Items.Cast<DigiCuit_alpha2.ElectricComponents.Component.Marker>().ToArray();
                this.circuit.PlugMatrix.AddRange(lComps);
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (i >= 0)
            {
                ...
                this.circuit.PlugMatrix.AddRange((DigiCuit_alpha2.ElectricComponents.Component.Marker[])lComps);
            }
        }
        ...
        private void cCompProperties_SelectedIndexChanged(object sender, EventArgs e)
        {
            int i = cCompProperties.SelectedIndex;
            if(i>=0)
            {
                if (cCompProperties.Items[i].GetType() == typeof(KeyValuePair<string, string>))
                {
                    KeyValuePair<string, string> prop = (KeyValuePair<string, string>)cCompProperties.Items[i];
                    cPropLabel.Text = prop.Key;
                    cPropValue.Text = prop.Value;
                }
            }
        }
        ...
        private void toolStripButton13_Click(object sender, EventArgs e)
        {
            ...
            if (i >= 0)
            {
                KeyValuePair<string, string> prop = new KeyValuePair<string, string>(cPropLabel.Text, cPropValue.Text );
                cCompProperties.Items[i] = prop;

                this.comp.Properties.Clear();
                object[] props = cCompProperties.Items.Cast<object>().ToArray();
                this.comp.Properties.AddRange(props);
            }
        ...
        {
            if (rend.IsRendering) { rend.RenderStop(); }
            else { rend.RenderStart(); }
        }
    }
}
